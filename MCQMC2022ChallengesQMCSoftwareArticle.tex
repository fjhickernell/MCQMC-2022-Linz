...
%%%%%%% Author sign off on this first submission, last revision 3/17/2023
...
\begin{itemize}
    ...
    \item Sobol' direction numbers \cite{JoeKuo03,KuoJoe08a,SobolDirection}
