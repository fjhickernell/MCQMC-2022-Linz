...
\begin{itemize}
	\item $g$ is the discounted payoff of a financial derivative and $\lambda$ be the probability density function (PDF) for a discretized Brownian motion \cite{Gla03},

	\item  $g$ is the velocity of a fluid at a point in rock with a random porosity field whose discretized PDF is $\lambda$, or
