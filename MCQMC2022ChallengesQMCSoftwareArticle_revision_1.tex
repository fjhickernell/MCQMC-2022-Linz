...
\SCComment{In QMCPy, we recognize the crucial role of non-code contributors to the project~\cite{K23}. Besides coding,  we also need documentation, interface design, testing, community management, and release management. These non-code contributions help make the project more  accessible. Non-coding roles offer opportunities for individuals with less coding experiences to develop technical and non-technical skills over time.  Additionally, the emergence of no-code or low-code analytical platform such as SAS Studio and SAS Viya offer a chance for individuals who are less experienced with complex coding to learn and contribute in a more user-friendly environment.  We need and welcome non-code contributors to work alongside code contributors, enhancing the overall health of the project and the diversity of the community. }
