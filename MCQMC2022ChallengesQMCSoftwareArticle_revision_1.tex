...
\LSComment{The beam model was written in C++ using the MUQ's model framework~\cite{MUQ2}. It is one of the UM-Bridge's benchmark problem library, available as a container.}
