...
\thanksnote{with input from Mark Klinchin, the GAIL an QMCPy teams, and  friends \\
	...
	Please join us Tuesday, July 19, for lunch at ??? \\ to discuss the future of MCQMC software \\[2ex]
...
\begin{frame}{Selective History of MC\textbf{QMC} Software}
	...
	\begin{itemize}
		...
		\item \alert{ACM} low discrepancy sequence generators \parencite{BraFox88,BraFoxNie92,HonHic00a}
		\item FinDer \parencite{PasTra95,FinDer} and BRODA \parencite{BRODA20a} targeting quantitative finance
		\item Korobov cubature and scrambled Sobol' generators in \alert{NAG} \parencite{NAG27} for decades		
		\item Scrambled Sobol' and Halton generators in MATLAB \textcite{MAT9.13} since 2008
	\end{itemize}
\end{frame}
