...
\begin{frame}{Ex.\ Connecting QMCPy with FEniCS/Dolfin}
\vspace{-4ex}
	\begin{itemize}
...
\section{Support}
\begin{frame}{Encouraging Users Requires \ldots}
	\begin{itemize}
		\item (Elementary) \alert{demos} that show how to use the software and its advantages over other approaches
		\item Demos showing  how the software \alert{connects} with other
	\end{itemize}
\end{frame}
