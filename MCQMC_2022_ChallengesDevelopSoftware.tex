...
\begin{frame}[allowframebreaks]{Selective History of MC\textbf{QMC} Software}
	\begin{itemize}
		...
		\item Low discrepancy generators \parencite{FriKel02,FriKelweb}, \alert{SamplePack} \parencite{SamplePack}, \textcite{Gru},  and \alert{MatBuilder} \parencite{paulin2022} by Alex Keller and collaborators
		\item L'Ecuyer
		\item Nuyens
		\item Giles
		\item Hickernell
