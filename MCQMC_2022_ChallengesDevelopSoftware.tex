...
\thanksnote{with input from Mark Klinchin, the GAIL an QMCPy teams, and  friends \\
	partially supported by SigOpt (Intel) and an Illinois  Tech alum\\[2ex]
	Join us Tuesday, July 19, at 12:45 PM for lunch at Bella Casa \\ to discuss the future of MCQMC software \\[2ex]
...
\begin{frame}{Choosing a Language, Library, or Environment}
    ...
    \begin{itemize}
    \item Realize your new idea as a \alert{demo} in your favorite library
    \item Add a significant idea as a \alert{feature} to other libraries
