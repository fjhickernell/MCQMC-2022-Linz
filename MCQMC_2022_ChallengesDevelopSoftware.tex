...
\begin{frame}{My Definition of a Great MCQMC Software Ecosystem}
...
\vspace{-2ex}
	\begin{itemize}
		...
		\item \alert{Multi-level} software \parencite{GilesSoft,GilesQSoft} 
...
\uncover<2->{The US Department of Energy is investing in studying how to develop great scientific software \parencite{Her19a,ASCR-SSSDU}}
\end{frame}
...
\begin{itemize}
    ...
    \item Had to learn how to change the random instance of coefficient without tiggering the JIT compile
