...
\begin{columns}
 \begin{column}{0.5\textwidth}
 	\begin{gather*}
 		-\frac{\dif }{\dif x}\biggl(a(x,\vW) \frac{\dif}{\dif x} u(x,\vW) \biggr) = 2x - 1 \\
 		 0 \leq x \leq 1, \qquad
 		u(0) = u(1) = 0 \\
 		a(x,\vW) = 1 + \beta \sum_{k=1}^d \frac{W_k T_{k}(2x-1)}{k^2} \\
 		 \vW \sim \cu[-1,1]^d \\
 	\end{gather*}
 \end{column}
 \begin{column}{0.5\textwidth}
 	\centering
 	\includegraphics[width=\textwidth]{ProgramsImages/timing-2.eps}
\end{column}
\end{columns}
\end{frame}
